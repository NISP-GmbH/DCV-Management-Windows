...
$Action = New-ScheduledTaskAction -Execute "PowerShell.exe" -Argument "-ExecutionPolicy Bypass -File @@AppPath@@\run_flask_app.ps1"
...
Register-ScheduledTask -TaskName "DCV Management" -Action $Action -Trigger $Trigger -Principal $Principal -Settings $Settings -Description "Runs the Flask app at system startup"
...
$binaryPath = "powershell.exe -ExecutionPolicy Bypass -File C:\@@AppPath@@\run_flask_app.ps1"
